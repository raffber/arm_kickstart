...
set(DIAGNOSTIC_OPTIONS "-Wall -Werror -Wno-unused-function -Wno-strict-aliasing -Wno-self-assign")
...
set(OBJECT_GEN_FLAGS "-O0 --target=arm-none-eabbi -mthumb ${DIAGNOSTIC_OPTIONS} -ffunction-sections -fdata-sections -fomit-frame-pointer -mabi=aapcs -nodefaultlibs -I${TOOLCHAIN_INC_DIR} ${TOOLCHAIN_CPU_OPTIONS}")
...
set(CMAKE_EXE_LINKER_FLAGS "-Wl,--gc-sections -mthumb -mabi=aapcs -fuse-ld=lld --target=arm-none-eabi ${TOOLCHAIN_CPU_OPTIONS}" CACHE INTERNAL "Linker options")
...
set(CMAKE_CXX_COMPILER ${TOOLCHAIN_BIN_DIR}/clang CACHE INTERNAL "C++ Compiler")
set(CMAKE_ASM_COMPILER ${TOOLCHAIN_BIN_DIR}/clang CACHE INTERNAL "ASM Compiler")
